...
public:
		...
		friend void operator<<(ostream& ,const List<Data,Key>& );
		...
		public:
			...
			const Data& operator *() const{ return m_current->data;}
			const Data& data() const{return m_current->data;}
			const Key& key() const{return m_current->key;}
		};
...
template <class Data,class Key>
void operator<<(ostream& out,const List<Data,Key>& l)
{
